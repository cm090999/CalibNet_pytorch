...
def options():
    ...
    parser.add_argument("--dataset_path",type=str,default='ONCE/data')
    ...
    parser.add_argument("--pretrained",type=str,default='./checkpoint/cam2_oneiter_best_DINO_Depth.pth')
